...
| [030](examples/030-livekit-agents-python/) | LiveKit Agents — Voice Assistant with Deepgram STT | Python | STT, TTS | LiveKit Agents |
...
| [090](examples/090-react-native-live-transcription-js/) | React Native Live Transcription | Node.js | STT | React Native |
| [100](examples/100-fastapi-audio-transcription-python/) | FastAPI Audio Transcription API | Python | STT | FastAPI |
| [110](examples/110-cloudflare-worker-transcription-js/) | Cloudflare Worker — Edge Audio Transcription | Node.js | STT | Cloudflare Workers |
| [120](examples/120-slack-transcribe-bot-node/) | Slack Bot — Auto-Transcribe Audio Messages with Deepgram | Node.js | STT | Slack |
<!-- examples-table-end -->
